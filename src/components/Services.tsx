      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          {services.map((service, i) => (
            <a href="/contact" key={i} className="block h-full">
              <motion.div 
                whileHover={{ y: -5 }}
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-12">
          <a href="/contact" className="px-6 py-3 bg-white/10 backdrop-blur-md text-white font-bold rounded-xl border border-white/20 hover:bg-white/20 transition-all text-sm">
            Book Tiffin Service
          </a>
          <a href="/contact" className="px-6 py-3 bg-orange-500 text-white font-bold rounded-xl shadow-lg hover:bg-orange-600 transition-all text-sm">
            Book Event Now
          </a>
        </div>
      </div>
